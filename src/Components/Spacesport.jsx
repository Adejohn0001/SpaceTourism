...
import sportM from '../assets/technology/image-spaceport-landscape.jpg';
        ...
        <div className='tech-container1'>
            ...
            <div className='tech-subcontainer1'>
                ...
                <div>
                    ...
                    <p className='tech-text2'> Space-Port </p>
                </div>

                <div>
                    <p className='tech-text3'>
                        A Space-Port or carrier rocket is a rocket-propelled
            ...
            <div>
                    <img src={sport} alt="launch" srcset="" className='launch-img' />
                    <img src={sportM} alt="launch" srcset="" className='launch-imgM' />
